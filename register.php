<!-- inclure Register.php -->
<?php require_once('./controller/Register.php'); ?>
<?php
  //créer un objet de la class Register
  $Register = new Register();
  //initialiser la variable $Response
  $Response = [];
  //affecter 'Register' dans la variable $active
  $active = $Register->active;
  //si $_POST est defini et !=null et qu'il y a au moins un element dans le tableau $_POST
    ...
    <div class="container">
      <div class="row justify-content-center mt-5">
        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-4 col-lg-4 center-align center-block">
          <!-- le tableau est défini et !=null et $Response['status']==false alors envoie une erreur dans le formulaire -->
          ...
          <!-- method post pour envoyer le formulaire echo $_SERVER['PHP_SELF'] pour envoyer sur la même page-->
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
              <div class="form-group">
                ...
                <!--si $_POST['name'] est defini et != de null alors affiche le nom  -->
                ...
                <!-- si $Response['name'] est defini et != de null et elle n'est pas vide -->
                <?php if (isset($Response['name']) && !empty($Response['name'])): ?>
                  <!-- affiche $Response['name'] -->
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
              <div class="form-group">
                ...
                <!--si $_POST['email'] est defini et != de null alors affiche l'email  -->
                ...
                <!-- si $Response['email'] est defini et != de null et elle n'est pas vide -->
                <?php if (isset($Response['email']) && !empty($Response['email'])): ?>
                  <!-- affiche $Response['email'] -->
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
              <div class="form-group">
                ...
                <!--si $_POST['phone'] est defini et != de null alors affiche le phone  -->
                ...
                <!-- si $Response['phone'] est defini et != de null et elle n'est pas vide -->
                <?php if (isset($Response['phone']) && !empty($Response['phone'])): ?>
                <!-- affiche $Response['phone'] -->
